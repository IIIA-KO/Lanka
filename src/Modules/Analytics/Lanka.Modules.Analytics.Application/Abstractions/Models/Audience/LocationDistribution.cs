...
public record LocationDistribution(LocationPercentage[] TopLocationPercentages)
{
    ...
    public static Result<LocationDistribution> FromJson(JsonElement json)
    {
        ...
        return new LocationDistribution(topLocationPercentages);
    }
}

...
public sealed record ReachDistribution(int TotalReach, ReachPercentage[] ReachPercentages)
{
    ...
    public static Result<ReachDistribution> FromJson(JsonElement json)
    {
        ...
        return new ReachDistribution(totalReach, reachPercentages);
    }
}

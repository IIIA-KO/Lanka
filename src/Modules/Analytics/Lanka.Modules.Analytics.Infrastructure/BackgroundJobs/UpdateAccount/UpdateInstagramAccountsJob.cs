    ...
    )
    {
        ...
        if (token == null)
        {
            this._logger.LogWarning(
                "No token found for user {UserId} associated with Instagram account {AccountId}",
                userId, account.Id
            );
        ...
        {
            this._logger.LogWarning(
                "No current account found for user {UserId} associated with Instagram account {AccountId}",
                userId, account.Id
            );

...
namespace Lanka.Modules.Campaigns.Infrastructure.Migrations
{
    ...
    [Migration("20260520082314_AddPendingCampaignExpiryIndex")]
    partial class AddPendingCampaignExpiryIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lanka.Modules.Campaigns.Domain.Bloggers.Blogger", b =>
                {
                    ...
                    b.HasIndex("CategoryName")
                        .HasDatabaseName("ix_bloggers_category_name");
            ...
            modelBuilder.Entity("Lanka.Modules.Campaigns.Domain.Bloggers.Categories.Category", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                    ...
                    b.ToTable("categories", "campaigns");
            ...
            modelBuilder.Entity("Lanka.Modules.Campaigns.Domain.Bloggers.Blogger", b =>
                {
                    b.HasOne("Lanka.Modules.Campaigns.Domain.Bloggers.Categories.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_bloggers_categories_category_name");
            ...
            modelBuilder.Entity("Lanka.Modules.Campaigns.Domain.Campaigns.Campaign", b =>
                {
                    ...
                    b.OwnsOne("Lanka.Modules.Campaigns.Domain.Campaigns.Report", "Report", b1 =>
                        {
                            b1.Property<Guid>("CampaignId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.Property<string>("ContentDelivered")
                                .IsRequired()
                                .HasMaxLength(2000)
                                .HasColumnType("character varying(2000)")
                            ...
                            b1.Property<string[]>("PostPermalinks")
                                .IsRequired()
                                .HasColumnType("text[]")
                                .HasColumnName("report_post_permalinks");

                            b1.Property<DateTimeOffset>("SubmittedOnUtc")
                                .HasColumnType("timestamp with time zone")

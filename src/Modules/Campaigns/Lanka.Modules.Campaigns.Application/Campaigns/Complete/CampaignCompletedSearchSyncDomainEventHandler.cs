...
internal sealed class CampaignCompletedSearchSyncDomainEventHandler
    : DomainEventHandler<CampaignCompletedDomainEvent>
{
    private readonly ISender _sender;
    private readonly IEventBus _eventBus;
    private static readonly string[] _tags = ["campaign", "completed"];

    public CampaignCompletedSearchSyncDomainEventHandler(ISender sender, IEventBus eventBus)
    {
        this._sender = sender;
    ...
    )
    {
        ...
        var metadata = new Dictionary<string, object>
        {
            ...
            { "completedOnUtc", result.Value.CompletedOnUtc!.Value }
        };

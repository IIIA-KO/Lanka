...
internal sealed class CampaignCancelledSearchSyncDomainEventHandler
    : DomainEventHandler<CampaignCancelledDomainEvent>
{
    private readonly ISender _sender;
    private readonly IEventBus _eventBus;
    private static readonly string[] _tags = ["campaign", "cancelled"];

    public CampaignCancelledSearchSyncDomainEventHandler(ISender sender, IEventBus eventBus)
    {
        this._sender = sender;
    ...
    )
    {
        ...
        var metadata = new Dictionary<string, object>
        {
            ...
            { "cancelledOnUtc", result.Value.CancelledOnUtc!.Value }
        };

...
internal sealed class CampaignConfirmedSearchSyncDomainEventHandler
    : DomainEventHandler<CampaignConfirmedDomainEvent>
{
    private readonly ISender _sender;
    private readonly IEventBus _eventBus;
    private static readonly string[] _tags = ["campaign", "confirmed"];

    public CampaignConfirmedSearchSyncDomainEventHandler(ISender sender, IEventBus eventBus)
    {
        this._sender = sender;

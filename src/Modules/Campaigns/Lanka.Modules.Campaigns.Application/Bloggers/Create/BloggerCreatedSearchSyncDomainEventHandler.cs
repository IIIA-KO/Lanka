...
internal sealed class BloggerCreatedSearchSyncDomainEventHandler
    : DomainEventHandler<BloggerCreatedDomainEvent>
{
    private readonly ISender _sender;
    private readonly IEventBus _eventBus;
    private static readonly string[] _tags = ["blogger", "profile"];

    public BloggerCreatedSearchSyncDomainEventHandler(ISender sender, IEventBus eventBus)
    {
        this._sender = sender;
    ...
    public override async Task Handle(
        BloggerCreatedDomainEvent domainEvent,

...
internal sealed class PactCreatedSearchSyncDomainEventHandler
    : DomainEventHandler<PactCreatedDomainEvent>
{
    private readonly ISender _sender;
    private readonly IEventBus _eventBus;
    private static readonly string[] _tags = ["pact", "agreement"];

    public PactCreatedSearchSyncDomainEventHandler(ISender sender, IEventBus eventBus)
    {
        this._sender = sender;
    ...
    public override async Task Handle(
        PactCreatedDomainEvent domainEvent,

...
internal sealed class OfferUpdatedSearchSyncDomainEventHandler
    : DomainEventHandler<OfferUpdatedDomainEvent>
{
    private readonly ISender _sender;
    private readonly IEventBus _eventBus;
    private static readonly string[] _tags = ["offer", "service"];

    public OfferUpdatedSearchSyncDomainEventHandler(ISender sender, IEventBus eventBus)
    {
        this._sender = sender;
    ...
    public override async Task Handle(
        OfferUpdatedDomainEvent domainEvent,

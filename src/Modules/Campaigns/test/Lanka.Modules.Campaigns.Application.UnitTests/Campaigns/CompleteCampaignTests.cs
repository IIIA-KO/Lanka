...
public class CompleteCampaignTests
#pragma warning restore CA1515
{
    private static CompleteCampaignCommand Command => new(Guid.NewGuid());
    
    private readonly ICampaignRepository _campaignRepositoryMock;
    private readonly IUserContext _userContextMock;
    private readonly IUnitOfWork _unitOfWorkMock;
    
    private readonly CompleteCampaignCommandHandler _handler;

    public CompleteCampaignTests()
    {
        ...
        this._handler = new CompleteCampaignCommandHandler(
    ...
    [Fact]
    public async Task Handle_ShouldCompleteCampaign()
    {
        // Arrange
    ...
    [Fact]
    public async Task Handle_ShouldReturnNotDoneError_WhenCampaignIsAlreadyCompleted()
    {
        // Arrange
        ...
        // Assert
        result.IsFailure.Should().BeTrue();
        result.Error.Should().Be(CampaignErrors.NotDone);
    }
}

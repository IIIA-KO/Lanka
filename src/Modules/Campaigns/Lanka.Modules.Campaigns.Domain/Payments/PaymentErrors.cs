...
public static class PaymentErrors
{
    ...
    public static readonly Error NotFailed =
        Error.Problem("Payment.NotFailed", "Payment is not in Failed status");
    ...
    public static readonly Error InvalidSignature =
        Error.Problem("Payment.InvalidSignature", "Payment provider callback signature is invalid");

    public static readonly Error CampaignNotConfirmed =
        Error.Problem("Payment.CampaignNotConfirmed", "Payment can only be initiated for a Done campaign");

    public static Error ProviderNotConfigured(string description) =>
        Error.Problem("Payment.ProviderNotConfigured", description);
}

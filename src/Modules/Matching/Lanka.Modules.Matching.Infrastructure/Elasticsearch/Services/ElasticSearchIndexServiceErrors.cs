...
internal static class ElasticSearchIndexServiceErrors
{
    ...
    public static readonly Error UpdateFailed = Error.Failure(
        "ElasticSearchIndex.UpdateFailed",
        "Failed to update document in Elasticsearch"
    );

    public static readonly Error UpdateError = Error.Failure(
        "ElasticSearchIndex.UpdateError",
        "An error occurred while updating document in Elasticsearch"
    );
    ...
    public static Error UpdateErrorWithMessage(string message) => Error.Failure(
        "ElasticSearchIndex.UpdateError",
        message
    );

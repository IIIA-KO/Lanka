...
namespace Lanka.Modules.Matching.Application.UnitTests.SearchableDocuments;
...
internal static class SearchableDocumentData
{
    ...
    public static readonly IReadOnlyCollection<string> Tags = new[] { "technology", "programming", "testing" };
    ...
    public const string UpdatedTitle = "Updated Blog Post Title";
    
    public const string UpdatedContent = "This is updated content for the blog post.";
    
    public static readonly IReadOnlyCollection<string> UpdatedTags = new[] { "updated", "modified", "testing" };
}
